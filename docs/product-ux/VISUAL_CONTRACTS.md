...
- Сетка товаров использует `auto-fill` с ограниченным max track, чтобы одиночные карточки оставались карточками, а не широкими баннерами.
...
- `--product-card-min`: минимальная ширина grid track.
