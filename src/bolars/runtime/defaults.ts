...
export const DEFAULT_TEXTS = {
  brandName: 'БОЛАРС',
  brandTagline: 'строительные смеси',
  startInstruction: 'Поднесите штрих-код товара к сканеру',
  startWelcome: 'Добро пожаловать!',
  ...
  largeTextTitle: 'Крупный текст',
  largeTextHint: 'Настройте размер текста для вашего удобства',
  emptyCartTitle: 'Корзина пока пустая',
  emptyCartHint: 'Сканируйте штрих-код товара или найдите товар вручную.',
  total: 'Итого',
  totalToPay: 'Итого к оплате',
  cartItemsLabel: 'Товаров в корзине',
  positions: 'позиций',
  pieces: 'шт',
  ...
  packageChoiceHint: 'Выберите подходящий размер пакета',
  ...
  orderNumber: 'Заказ №',
  finalBrandThanks: 'Спасибо, что выбрали БОЛАРС!',
